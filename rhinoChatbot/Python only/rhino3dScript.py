...
while True:
    ...
    if flag == 1:
        ...
        nextAction = raw_input('What would you like to do next? ')
    if flag == 0: command = raw_input("Hello, I'm a chatbot for CAD modelling here in Rhino. What would you like to do? ")
    if len(command) > 0: flag = 1